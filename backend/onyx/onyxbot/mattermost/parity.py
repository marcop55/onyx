...
MATTERMOST_SLACK_PARITY_MATRIX: tuple[SlackToMattermostCapability, ...] = (
    ...
    SlackToMattermostCapability(
        ...
        mattermost_contract="Mattermost-native /orka slash commands validate the command token, re-check bot and sender channel membership, and route ask/sources through the durable Onyx handler while help/status stay ephemeral.",
        status=MattermostParityStatus.DIRECT_MATTERMOST_FEATURE,
        evidence=(
